...
Obj _35reg1686 = primCons(makeCString("primCar"), Nil);
Obj _35reg1687 = primCons(makeNumber(1), _35reg1686);
Obj _35reg1688 = primCons(intern("car"), _35reg1687);
Obj _35reg1689 = primCons(makeCString("primCdr"), Nil);
...
Obj _35reg1698 = primCons(makeCString("primAdd"), Nil);
Obj _35reg1699 = primCons(makeNumber(2), _35reg1698);
Obj _35reg1700 = primCons(intern("+"), _35reg1699);
Obj _35reg1701 = primCons(makeCString("primSub"), Nil);
